		...
		<BR>
			<BR>
				...
				<div class="user-info-list panel panel-default">
					<div class="panel-heading panel-heading-divider">Profil<span class="panel-subtitle"><?php echo CHtml::encode($model->job); ?></span></div>
						...
						<table class="no-border no-strip skills">
							<tbody class="no-border-x no-border-y">
								...
								<tr>
									...
									<td class="item">Kontak<span class="icon s7-phone"></span></td>
