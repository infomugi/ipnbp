					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							echo $form->dropDownList($model, "category_id",
								CHtml::listData(QuesionerWeight::model()->findall(),
									'id_quesioner_weight', 'name'
									),
								array("empty"=>"-- Jenis Kuesioner --", 'class'=>'select2 form-control')
								); 
								?> 
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<?php echo $form->textField($model,'question_sort',array('class'=>'form-control','value'=>Question::model()->countQuestion()+1)); ?>
							</div>
