...
<head>
	...
	<title>Email Template - Modern Flat</title>
                															...
                															<tr>
                																	...
                																	<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%">
                																		<tr>
                																			<td align="left" class="textContent">
                																				<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%">The introduction of your message preview goes here. Try to make it short.</div>
                																			</td>
                																		</tr>
                																	</table>
                																</td>
                																<td align="right" valign="middle" class="flexibleContainerBox">
                																	<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%">
                																		<tr>
                																			<td align="left" class="textContent">
                																				<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%">If you can't see this message <a href="www.infomugi.com#" target="_blank" style="text-decoration:none;border-bottom:1px solid #828282;color:#828282"><span style="color:#828282">View&nbsp;it&nbsp;in&nbsp;your&nbsp;browser</span></a>.</div>
                																			</td>
                																		</tr>
                																	</table>
                																</td>
                											...
                											<table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
                												<tr>
                													<td align="center" valign="top" width="500" class="flexibleContainerCell">
                														<table border="0" cellpadding="0" cellspacing="0" width="100%">
                															<tr>
                																<td align="center" valign="top" class="textContent"><img src="assets/images/small/bg.jpg" alt="" style="max-width:500px;width:100%;display:block"></td>
                															</tr>
                														</table>
                													</td>
                												</tr>
                																						...
                																						<tr>
                																							<td valign="top" class="textContent">
                																								<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#cccccc;line-height:150%">
                																									<p style="color:#999999;font-size:14px;line-height:20px;font-family:Arial,Helvetica,sans-serif;margin-top:0;margin-bottom:12px;padding-top:0;padding-bottom:0;font-weight:normal"><strong><a href="www.infomugi.com#" style="color:#0088cc" target="_blank">Like On Facebook</a></strong> | <strong><a href="www.infomugi.com#" style="color:#0088cc" target="_blank">Follow On Twitter</a></strong></p>
                																								</div>
                																							</td>
                																						</tr>
                																					</tbody>
                														...
                														<table border="0" cellpadding="30" cellspacing="0" width="100%">
                															<tr>
                																<td valign="top" bgcolor="#E1E1E1">
                																	...
                																	<div>Copyright &#169; 2015 <a href="www.infomugi.com#" style="text-decoration:none;color:#828282"><span style="color:#828282">Infomugi Media</span></a>. All rights reserved.</div>
                																	</div>
                																</td>
                															</tr>
                														</table>
