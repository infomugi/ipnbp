...
Rekapitulasi Hasil Pengujian <B><?php echo Company::model()->name($company); ?></B> Tanggal : <B><?php echo Request::model()->date($startdate); ?></B> s/d <B><?php echo Request::model()->date($enddate); ?></B> 
<div class="datagrid">
	...
	// 'filter'=>$model,	
		...
		'columns'=>array(
			...
			array(	
				'header'=>'Nama Balai',
				'value'=>'Unit::model()->name($data->testing_part)',
				),	
