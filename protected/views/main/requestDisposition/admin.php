...
$this->pageTitle='Manage Disposisi';
?>
...
<span class="visible-xs">
	...
	<?php echo CHtml::link('<i class="fa fa-plus"></i>',
		...
		<span class="hidden-xs">
			...
			<?php echo CHtml::link('Add Disposisi',
				array('create'),
				array('class' => 'btn btn-primary btn-flat'));
				?>
				<?php echo CHtml::link('List Disposisi',
					array('index'),
					array('class' => 'btn btn-primary btn-flat'));
					?>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-header">
											...
											<h4 class="modal-title"><strong>View</strong> Disposisi</h4>
										</div>
										<!-- Popup Content -->
