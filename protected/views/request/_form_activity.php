...
<ul class="user-timeline user-timeline-compact">
	...
	<li>
		...
		<div class="user-timeline-date"><?php echo $activity->report_send_date; ?></div>
		<div class="user-timeline-description">Tanggal Kirim Laporan</div>
		<div class="user-timeline-date"><?php echo $activity->report_accept_date; ?></div>
