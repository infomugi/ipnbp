		...
		<div class="col-lg-9 col-md-10"> 
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<?php echo $form->textField($payment,'invoice_id',array('class'=>'form-control')); ?>
				</div>
		...
		'columns'=>array(
			...
			array(
				...
				'buttons'=>array(
					'update'=>
					array(
						'url'=>'Yii::app()->createUrl("requestpayment/update", array("id"=>$data->id_payment))',
						),
					'delete'=>
					array(
						'url'=>'Yii::app()->createUrl("requestpayment/delete", array("id"=>$data->id_payment))',
						),
					),
				),
			),
